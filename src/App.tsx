...
export default function QuizApp() {
  ...
  const QUESTION_TIME = 10; // timer 10s
  ...
  function handleExit() {
    // For browsers, window.close only works if the page was opened by window.open.
        ...
        <div className="mb-6">
          ...
          <div className="grid gap-3">
            {q.options.map((opt, i) => {
              ...
              return (
                <button key={i} onClick={() => handleSelect(i)} disabled={isAnswerRevealed} className={`${base} ${style} flex items-center justify-between`}>
